  ...
  return (
    <div className='pt-[64px] landingPageMainDiv'>
      <div className="text-center flex flex-col mx-auto max-w-[1037px]">
        ...
        <span className="mt-6 text-[60px] md:text-[64px] font-semibold leading:[20px] md:leading-[96px]">A playground for <span className="text-customprimary">creatives</span> about  <span className="text-customprimary">brands</span> to <span className="text-customprimary">connect</span> </span>
