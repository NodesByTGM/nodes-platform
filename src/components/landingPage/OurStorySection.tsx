...
export function Section({ title, text1, text2 }) {
  return (
    <div className=" ">
      <div className="flex flex-col md:flex-row gap-10 md:gap-20 justify-between items-start text-[#000000]">
        <div className="flex flex-col gap-4 max-w-[540px] md:min-w-[360px] lg:min-w-[540px]">
          <span className="font-medium text-[24px] md:text-[40px]">{title}</span>
        </div>
        <div className="text-base md:text-[18px] font-normal flex flex-col gap-8">
          <p>{text1}</p>
          <p>{text2}</p>
        </div>
      </div>
