  ...
  return (
    <div>
      ...
      <div className="w-full flex items-center justify-start">
        {" "}
        <span className="font-normal text-center text-base text-[#212121]">
          {text}
        </span>
      </div>
      <div className="grid grid-cols-2 gap-4 mt-10">
        <div onClick={() => closeModal()} className="flex-1">
          <button className="border-[#EFEFEF] border h-full w-full outline-none focus:outline-nnone main-bg-gray rounded-lg">
            No, Cancel
          </button>
        </div>
