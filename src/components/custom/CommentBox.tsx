...
function Comment({ last = false }) {
    return (
        <div className="mb-5">
            ...
            <div>
                <p className="mb-4 text-sm">Lorem ipsum dolor sit amet consectetur. Pharetra elementum mattis et duis dis.</p>
                <div className="flex gap-4 items-center">
                    <div className="flex gap-2 items-center text-placeholder"><ThumbsDown className="w-4 " /> <span>2</span> </div>
                    <div className="flex gap-2 items-center text-placeholder"><ThumbsUp className="w-4 " /> <span>2</span> </div>
                </div>
            </div>
...
function CommentBox({ opened = false, setOpened = () => { } }: any) {
    ...
    return (
        <div>
            ...
            <div className={clsx(
                "fixed bg-white p-5 z-50 w-[400px] h-[98vh] top-2 right-2 rounded-lg transition-all duration-300 overflow-auto",
                ...
                <div className="">
                    <div className="border rounded-lg p-4 mb-10">
                        ...
                        <textarea rows={5} className="w-full outline-none" placeholder={'What are your thoughts'}></textarea>
                        <div className="flex gap-2 justify-end">
                            <Button size="sm" className="!bg-white !border-none !text-black">Cancel</Button>
                    ...
                    <div className="w-[100px] mb-10">
                        ...
                        <Select
                            className="flex-1"
                            placeholder={'Latest'} id="month"
                            // options={AppConfig.DATE_OPTIONS.DAYS}
                            showCarret
                            onSelect={handleSelect} />
                    </div>
                    <div className="">
                        {Array(2).fill(null).map((_, i) => <Comment key={i} last={i==1} />)}
                    </div>
                </div>
            </div>
        </div>
