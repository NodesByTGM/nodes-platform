...
import { Bell, ChevronDown, Flag, LogOut, Mail, Menu, Settings, Smartphone } from "react-feather"
        ...
        <div className="py-2 pr-4 w-full flex justify-between items-center border-b">
            <div className="flex gap-4 items-center">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Searchbar searchTerm={searchTerm} setSearchTerm={setSearchTerm} className="hidden md:block" />
                </div>
            </div>

            <div className="flex gap-2 items-center">
                <div className="md:block hidden">
                    <Button theme={'secondary'} className="!border-grey-dark " size={'sm'} onClick={() => setAppOpened(!appOpened)}>
                ...
                <div className="flex items-center cursor-pointer" onClick={() => setMenuOpened(!menuOpened)}>
