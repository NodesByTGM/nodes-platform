                    ...
                    <div>
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <div className="flex justify-between gap-4 items-center">
                                ...
                                <div className="flex justify-between gap-2 items-center cursor-pointer" onClick={()=>setOpened(true)}>
                                    <span className="text-primary"><MessageSquare /></span>
                                    <span>32</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex justify-between gap-4 items-center w-full">
                            <div className="h-8 w-8 text-sm rounded-full bg-primary text-white flex justify-center items-center">AA</div>
                            <input type="text" className="p-2 flex-1 rounded border border-grey-dark outline-none" />
                        </div>
                    </div>
                </div>
                <div className="w-full lg:w-1/2 bg-cover bg-center ">
                    <img src="/img/post.jpeg" alt="" className="w-full max-w-[400px h-[600px]"/>
                </div>
            </div>
