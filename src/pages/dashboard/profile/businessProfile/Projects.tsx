...
import { ProjectCard2, Modal, Loader } from "../../../../components";
...
export default function Projects() {
  ...
  return (
    <div className="relative flex flex-col min-h-[350px]">
      ...
      {!projectsLoading && projectsData.length === 0 ? (
        <div className="mt-6 mx-auto max-w-[219px] flex flex-col justify-center items-center ">
          ...
          <span className="mt-8 text-center font-normal text-base text-[#212121]">
            Nothing to see here yet, add a projectto get started.
          </span>
