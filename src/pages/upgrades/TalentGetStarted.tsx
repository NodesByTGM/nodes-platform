...
import { Button, Input, OTPInput, PasswordInput, TalentCTA } from "../../components";
...
function TalentSignUp() {
    ...
    const sendOTP = () => {
        mainClient.post(AppConfig.API_ENDPOINTS.Auth.SendOTP, formData)
            .then(r => {
                if (r.status === 200) {
                ...
                {currentIndex === 0 ? (
                    <div className="">
                        <div className="mb-4">
                            ...
                            <p>Showcase your talent, build meaningful connections, and be part of a community that celebrates your unique perspective.</p>
                        </div>
                        <div className="flex flex-col gap-4 justify-center w-full">
                            ...
                            <Button
                                className="my-8"
                                disabled={!validateObjectValues(formData) || (sent && !resendAllowed)}
